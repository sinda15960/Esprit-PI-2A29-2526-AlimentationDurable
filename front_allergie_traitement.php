...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .feature-btn.pollen { background: #4caf50; color: white; box-shadow: 0 4px 12px rgba(76,175,80,0.3); }
        .feature-btn.urgence { background: #f44336; color: white; box-shadow: 0 4px 12px rgba(244,67,54,0.3); }
...
<body>
    ...
    <div class="feature-buttons">
        ...
        <a href="compare_allergies.php" class="feature-btn compare">
            <i class="fas fa-chart-simple"></i> ⚖️ Comparateur
        </a>
        <a href="pollen_alerts.php" class="feature-btn pollen">
            <i class="fas fa-leaf"></i> 🌤️ Alertes Pollen
        </a>
        <a href="urgence_config.php" class="feature-btn urgence">
            <i class="fas fa-ambulance"></i> 🆘 Contacts Urgence
        </a>
    </div>
