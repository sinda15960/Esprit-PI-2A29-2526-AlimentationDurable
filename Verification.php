...
<head>
    ...
    <style>
        ...
        h1, h2 { color: #2d5016; }
        .alert-success { background: #d4edda; color: #155724; padding: 1rem; border-radius: 5px; margin: 1rem 0; border: 1px solid #c3e6cb; }
        .alert-error { background: #f8d7da; color: #721c24; padding: 1rem; border-radius: 5px; margin: 1rem 0; border: 1px solid #f5c6cb; }
        .btn { background: #2d5016; color: white; padding: 0.8rem 1.5rem; text-decoration: none; border-radius: 5px; display: inline-block; margin-top: 1rem; }
...
<body>
    <div class="container">
        ...
        <a href="../View/BackOffice/back_allergie_traitement.php" class="btn">← Retour à la gestion</a>
    </div>
</body>
</html>