...
<h2 class="section-title">📋 Ajouter un Programme</h2>

<div class="card">
    <div class="card-body">
        <form method="POST" action="index.php?module=programme&action=store&office=back" id="formProgramme">
            ...
            <div class="mb-3">
                ...
                <select name="niveau" id="niveau" class="form-select <?= isset($errors['niveau']) ? 'is-invalid' : '' ?>">
                    ...
                    <option value="<?= $n ?>" <?= (($_POST['niveau'] ?? '') === $n) ? 'selected' : '' ?>><?= ucfirst($n) ?></option>
                    <?php endforeach; ?>
                </select>
            ...
            <div class="mb-3">
                ...
                <select name="objectif_id" id="objectif_id" class="form-select">
                    ...
                    <option value="<?= $o['id'] ?>" <?= (($_POST['objectif_id'] ?? '') == $o['id']) ? 'selected' : '' ?>>
