    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .sidebar .logo {
            ...
            font-weight: bold;
            padding: 25px 20px;
            border-bottom: 1px solid #3d7a35;
        }
        .sidebar a {
            display: block;
            color: #c8e6c4;
...
<div class="sidebar">
    ...
    <a href="index.php?module=programme&action=index&office=back">📋 Programmes</a>
    <a href="index.php?module=exercice&action=index&office=back">🏋️ Exercices</a>
</div>
...
<nav class="navbar navbar-expand-lg">
    <div class="container">
        ...
        <div class="ms-auto d-flex gap-2 align-items-center">
            ...
            <!-- LIEN MODIFIÉ : Mes objectifs au lieu de Mes exercices -->
            <?php if (isset($_SESSION['role']) && $_SESSION['role'] === 'admin'): ?>
                <a href="index.php?module=objectif&action=index&office=back" class="btn btn-sm btn-warning">⚙️ Admin</a>
            <?php endif; ?>
            <?php if (isset($_SESSION['user_nom'])): ?>
                <span class="user-badge">👤 <?= htmlspecialchars($_SESSION['user_nom']) ?></span>
            <?php endif; ?>
            <a href="index.php?action=logout&office=front" class="btn btn-sm btn-outline-light">🚪 Déconnexion</a>
        </div>
    </div>
</nav>
